...
class EVITBackbone(ViTBackbone):
    """
    Only changes the block class to EVITBlock, which implements the EVIT logic.
    """
    ...
    def __init__(self, block_config, depth, position_encoding_size, input_size,
        ...
        # Replace all Block instances with EVITBlock instances.
        ...
        for i in range(depth):
            ...
            new_blocks.append(EVITBlock(input_size=input_size, has_class_token=has_class_token, **block_config_i, **tbkv_config))
