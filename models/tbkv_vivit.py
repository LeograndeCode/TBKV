...
from eventful_transformer.tbkv_backbone import TBKVViTBackbone
...
class TBKVFactorizedViViT(ExtendedModule):
    """
    ...
    def _forward_view(self, x):
        ...
        # NOTE: Do NOT call self.spatial_model.reset() here for TBKV.
